...
class DamageCalculator:
    ...
    def get_critical_modifier(self):
        ...
        crit_level = 0
        if self._poke_1.held_item != None and self._poke_1.held_item.name in ["Razor Claw", "Scope Lens"]:
            crit_level += 1
        if self._poke_1.name == "Farfetch'd" and self._poke_1.held_item != None and self._poke_1.held_item.name == "Stick":
            crit_level += 2
        if self._poke_1.name == "Chansey" and self._poke_1.held_item != None and self._poke_1.held_item.name == "Lucky Punch":
            crit_level += 2
    ...
    def get_burn_modifier(self):
        ...
        if "burn" in self._poke_1.status:
            if self._poke_1.ability != None and self._poke_1.ability.ability_name != "Guts":
