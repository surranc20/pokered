...
class FrameManager(object):
   ...
   class _FM(object):
      ...
      _FRAME_SIZES = {
         ...
         join("pc", "box_headers.png"): (124, 22),
         join("pc", "box_backgrounds.png") : (156, 116),
         join("pc", "party_pokemon.png"): (70, 16),
         join("pc", "close_box.png"): (70, 16),
         join("pc", "box_arrows.png"): (8, 12),
         join("pc", "hands.png"): (20, 22),
         join("pc", "pokemon_data.png"): (80, 156),
         join("pc", "lightning_r.png"): (12, 7),
         join("pc", "lightning_l.png"): (12, 7),
         join("pc", "box_hand.png"): (32, 32),
         join("pc", "withdraw_tab.png"): (94, 160),
         "party_font.png" : (5, 8),
