...
"""This module was coded by my brother Kolbe Surran. User name shockedeel on
github"""
...
class StatCalculator:
    ...
    def calculate_main(self, pokemon, lvl):
        with open(join("jsons", "pokemon.json"), "r") as pokemonfile:
            ...
            base_defense = \
                pokemon_j[pokemon.name.capitalize()]["base"]["Defense"]
            base_sp_attack = \
                pokemon_j[pokemon.name.capitalize()]["base"]["Sp. Attack"]
            base_sp_defense = \
                pokemon_j[pokemon.name.capitalize()]["base"]["Sp. Defense"]
