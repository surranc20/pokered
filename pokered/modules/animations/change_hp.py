...
class ChangeHP(PokeInfo):
    """This is the animation that plays while the pokemon's health bar slowly
    goes down. This is necessary becuase the health bar does not simply drop
    all at once. It slowly goes down."""
    ...
    def update(self, ticks):
        """Achieves the animation effect by decrementing a counter by one and
        creating a new poke info with hp set to that counter. Once all damage
        has been accounted for the animation is over."""
