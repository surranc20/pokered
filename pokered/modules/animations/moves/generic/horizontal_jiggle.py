...
class HorizontalJiggle():
    ...
    def draw(self, draw_surface):
        """Since this animation simply moves the pokemon it does not need to do anything 
    ...
    def update(self, ticks):
        ...
        if not self.is_dead():
            ...
            # Jiggle the pokemon based on where it is relative to anchor point (its start point)
