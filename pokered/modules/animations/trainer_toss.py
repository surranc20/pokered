...
class TrainerToss(AnimatedGroupPart):
    def __init__(self, position, anim_sequence_pos):
        """First part of the AnimatedGroup Toss_Pokmeon. Moves trainer image
    ...
    def update(self, ticks):
        ...
        # Once the trainer is about to travel off screen he begins animating
        # again.
        ...
        if self._animationTimer > 1 / self._framesPerSecond:
            ...
            self._image = FRAMES.getFrame(self._imageName, (self._frame,
                                                            self._row))

            # If the animation is on the last frame then stop animating and
            # return the index of the next AnimatedGroupPart. In this case
            # that is the index of a BallToss.
